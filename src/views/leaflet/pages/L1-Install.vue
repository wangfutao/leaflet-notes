<template>
    <div>
        <div class="content">
            <div class="md-content markdown-body" v-html="mdContent"> </div>
...
// @ts-ignore
import L1Text from "../mds/L1-Install.md";
import * as L from "leaflet";
export default class L1Install extends Vue{
    mdContent = "";

    mounted(){
        let convert = new showdown.Converter();
        let html = convert.makeHtml(L1Text);
        this.mdContent = html;
